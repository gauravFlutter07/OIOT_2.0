...
class Acsp {
  ...
  final dynamic taxcgst;
  final int? taxPercentagesgst;
  final dynamic taxsgst;
  final int? tollFee;
  final bool? isNight;
  final bool? isPeak;
  final String? surgeReason;
  final dynamic surgeAmt;
  ...
  final String? time;
  final int? timefare;
  final dynamic comison;
  final int? cost;
  final String? via;
  final dynamic actualcost;
  final dynamic bal;
  final dynamic booking;
  final dynamic carddebt;
  final dynamic chId;
  final dynamic conveyance;
  final dynamic costBeforeDiscount;
  final dynamic detect;
  final dynamic fareAmtBeforeSurge;
  final String? fareType;
  final dynamic farewithoutTaxNBookingFee;
  final dynamic minFare;
  final String? minwaitingTime;
  final double? nightPer;
  final dynamic oldBalance;
  final dynamic outstanding;
  final dynamic peakPer;
  final dynamic perKmRate;
  final dynamic promoamt;
  final dynamic tax;
  final dynamic totalFareWithOutOldBal;
  final dynamic totalwaitingTime;
  final dynamic waitingCharge;
  final dynamic waitingRate;
  final String? waitingTime;
  final dynamic walletdebt;
